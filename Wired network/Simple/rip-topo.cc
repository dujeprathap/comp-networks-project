...
int main (int argc, char **argv){
	...
	p2p.SetDeviceAttribute  ("DataRate", StringValue ("3Kbps"));
	NetDeviceContainer netDev3 = p2p.Install (cont3);
	
	//Setting the routing protocol as RIP
	...
	p2p.EnableAsciiAll (ascii.CreateFileStream ("rip-trace-topo1.tr"));
	p2p.EnablePcapAll ("rip-pcap-topo1", true);
	...
	anim= new AnimationInterface("rip-anim1.xml");
	...
	flowMonitor->SerializeToXmlFile("flow-rip-topo1.xml", true, true);  
