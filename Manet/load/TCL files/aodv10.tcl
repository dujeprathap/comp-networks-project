...
$ns at 1.0 " $n8 setdest 524 38 $speed " 
$ns at 10.0 " $n0 setdest 210 220 $speed " 

$ns at 3.0 " $n11 setdest 690 518 $speed " 
$ns at 8.0 " $n9 setdest 899 210 $speed " 

$ns at 5.0 " $n4 setdest 489 319 $speed " 
$ns at 1.0 " $n2 setdest 97 613 $speed " 

$ns at 7.0 " $n12 setdest 716 367 $speed " 
$ns at 8.0 " $n7 setdest 138 503 $speed " 
...
$ns at 0.0 "$n18 label \"Source1\""
$ns attach-agent $n18 $udp0
set null16 [new Agent/Null]
$ns at 0.0 "$n6 label \"Destination1\""
$ns attach-agent $n6 $null16
$ns connect $udp0 $null16
$udp0 set packetSize_ 1024

$ns at 0.0 "$n18 color #ff00ff"
$n18 color "#ff00ff"
$ns at 0.0 "$n6 color #ff00ff"
$n6 color "#ff00ff"

#Setup a UDP connection
set udp2 [new Agent/UDP]
$ns at 0.0 "$n13 label \"Source2\""
$ns attach-agent $n13 $udp2
set null1 [new Agent/Null]
$ns at 0.0 "$n15 label \"Destination2\""
$ns attach-agent $n15 $null1
$ns connect $udp2 $null1
$udp2 set packetSize_ 1024

$ns at 0.0 "$n13 color #00ff00"
$n13 color "#00ff00"
$ns at 0.0 "$n15 color #00ff00"
$n15 color "#00ff00"

#Setup a UDP connection
set udp5 [new Agent/UDP]
$ns at 0.0 "$n1 label \"Source3\""
$ns attach-agent $n1 $udp5
set null14 [new Agent/Null]
$ns at 0.0 "$n3 label \"Destination3\""
$ns attach-agent $n3 $null14
$ns connect $udp5 $null14
$udp5 set packetSize_ 1024

$ns at 0.0 "$n1 color #663300"
$n1 color "#663300"
$ns at 0.0 "$n3 color #663300"
$n3 color "#663300"

#Setup a UDP connection
set udp8 [new Agent/UDP]
$ns at 0.0 "$n8 label \"Source4\""
$ns attach-agent $n8 $udp8
set null13 [new Agent/Null]
$ns at 0.0 "$n0 label \"Destination4\""
$ns attach-agent $n0 $null13
$ns connect $udp8 $null13
$udp8 set packetSize_ 1024

$ns at 0.0 "$n8 color #cc0000"
$n8 color "#cc0000"
$ns at 0.0 "$n0 color #cc0000"
$n0 color "#cc0000"

#Setup a UDP connection
set udp9 [new Agent/UDP]
$ns at 0.0 "$n11 label \"Source5\""
$ns attach-agent $n11 $udp9
set null15 [new Agent/Null]
$ns at 0.0 "$n9 label \"Destination5\""
$ns attach-agent $n9 $null15
$ns connect $udp9 $null15
$udp9 set packetSize_ 1024

$ns at 0.0 "$n11 color #0066cc"
$n11 color "#0066cc"
$ns at 0.0 "$n9 color #0066cc"
$n9 color "#0066cc"

#Setup a UDP connection
set udp10 [new Agent/UDP]
$ns at 0.0 "$n4 label \"Source6\""
$ns attach-agent $n4 $udp10
set null4 [new Agent/Null]
$ns at 0.0 "$n2 label \"Destination6\""
$ns attach-agent $n2 $null4
$ns connect $udp10 $null4
$udp10 set packetSize_ 1024

$ns at 0.0 "$n4 color #006666"
$n4 color "#006666"
$ns at 0.0 "$n2 color #006666"
$n2 color "#006666"

#Setup a UDP connection
set udp11 [new Agent/UDP]
$ns at 0.0 "$n12 label \"Source7\""
$ns attach-agent $n12 $udp11
set null17 [new Agent/Null]
$ns at 0.0 "$n7 label \"Destination7\""
$ns attach-agent $n7 $null17
$ns connect $udp11 $null17
$udp11 set packetSize_ 1024

$ns at 0.0 "$n12 color #ffff00"
$n12 color "#ffff00"
$ns at 0.0 "$n7 color #ffff00"
$n7 color "#ffff00"

#Setup a UDP connection
set udp18 [new Agent/UDP]
$ns at 0.0 "$n2 label \"Source8\""
$ns attach-agent $n2 $udp18
set null7 [new Agent/Null]
$ns at 0.0 "$n10 label \"Destination8\""
$ns attach-agent $n10 $null7
$ns connect $udp18 $null7
$udp18 set packetSize_ 1024

$ns at 0.0 "$n2 color #996600"
$n2 color "#996600"
$ns at 0.0 "$n10 color #996600"
$n10 color "#996600"

#Setup a UDP connection
set udp19 [new Agent/UDP]
$ns at 0.0 "$n10 label \"Source9\""
$ns attach-agent $n10 $udp19
set null8 [new Agent/Null]
$ns at 0.0 "$n7 label \"Destination9\""
$ns attach-agent $n7 $null8
$ns connect $udp19 $null8
$udp19 set packetSize_ 1024

$ns at 0.0 "$n10 color #999966"
$n10 color "#999966"
$ns at 0.0 "$n7 color #999966"
$n7 color "#999966"

#Setup a UDP connection
set udp20 [new Agent/UDP]
$ns at 0.0 "$n17 label \"Source10\""
$ns attach-agent $n17 $udp20
set null9 [new Agent/Null]
$ns at 0.0 "$n14 label \"Destination10\""
$ns attach-agent $n14 $null9
$ns connect $udp20 $null9
$udp20 set packetSize_ 1024

$ns at 0.0 "$n17 color #3366ff"
$n17 color "#3366ff"
$ns at 0.0 "$n14 color #3366ff"
$n14 color "#3366ff"
...
proc finish {} {
    ...
    close $namfile
    # exec nam aodv10.nam &
	exec gawk -f load_metrics.awk aodv10.tr &
    exit 0
}
